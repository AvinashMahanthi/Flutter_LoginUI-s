...
import 'package:loginui/Login_ui_10/SignUp10.dart';

class Login10 extends StatefulWidget {
  @override
  _Login10 createState() => _Login10();
}

class _Login10 extends State<Login10> {
  @override
    ...
    child: Row(
      ...
      children: <Widget>[
        GestureDetector(
          onTap: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (context) => SignUp10()));
          },
          child: Text(
            'Sign up',
            style: TextStyle(
